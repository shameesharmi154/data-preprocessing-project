...
## Submission
- Add this repository to Git and share the GitHub link with the operations team. Ensure `data/dataset.csv` is included.

---

*If you want, I can also add unit tests or a small example notebook that demonstrates the full pipeline step-by-step.*